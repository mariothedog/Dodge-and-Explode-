...
func _ready():
	...
	$"Slow-mo Visual Effect".material.set_shader_param("apply", false)
...
func _on_Player_slow_mo_enabled():
	$"Slow-mo Visual Effect".material.set_shader_param("apply", true)
...
func _process(_delta):
	if $Player.slow_mo_enabled:
		...
		$"Slow-mo Visual Effect".material.set_shader_param("blur_amount", amount)
		
		$"Slow-mo Visual Effect".material.set_shader_param("chromatic_amount", amount)
		...
		$"Slow-mo Visual Effect".material.set_shader_param("darkness_multi", darkness_multi)
